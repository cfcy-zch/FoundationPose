...
gnome-terminal --window -e 'bash -c "roslaunch aubo_i5_moveit_config moveit_planning_execution.launch robot_ip:=127.0.0.1; exec bash"' \
--window -e 'bash -c "sleep 5; source ~/anaconda3/etc/profile.d/conda.sh; conda activate foundationpose; /home/hh/anaconda3/envs/foundationpose/bin/python /home/hh/ros1_ws/src/FoundationPose/grasp_final.py; exec bash"' \
